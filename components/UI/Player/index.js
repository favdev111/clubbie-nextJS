...
import {selectFigForNaming, setActivePlayer} from "../../../redux/actions/pitchActions";
...
const Player = ({figId, name, isCaptain, colorPlayer, setupCaptain}) => {
    ...
    return (
        <div  className={`${styles.player} ${activePlayer.id === figId ? styles.activePlayer : styles.nonactivePlayer}`}>
            <div
            ...
            }
            {
                ...
                <div className={`${styles.playerName} ${name.length > 0 ? styles.activeName : styles.nonactiveName}`}>
