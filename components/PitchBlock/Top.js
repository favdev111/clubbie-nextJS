            ...
            <div className={styles.top}>
                ...
                <ul className={styles.topFormat}>
                    <li
                        ...
                        className={`${styles.topFormatItem} ${lineUp === '4-4-2' ? styles.activeLineup :''}`}
                    >
                        4-4-2
                    </li>
                    <li
                        onClick={formationHandler}
                        className={`${styles.topFormatItem} ${lineUp === '4-3-3' ? styles.activeLineup :''}`}
                    >
                        4-3-3
                    </li>
                    <li
                        onClick={formationHandler}
                        className={`${styles.topFormatItem} ${lineUp === '4-5-1' ? styles.activeLineup :''}`}
                    >
                        4-5-1
                    </li>
                    <li
                        onClick={formationHandler}
                        className={`${styles.topFormatItem} ${lineUp === 'No formation' ?styles.activeLineup :''}`}
                    >
                        No formation
                    </li>
                </ul>
