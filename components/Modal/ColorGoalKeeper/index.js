...
const ColorGoalKModal = ({state, closeGoalKModalHandler, colorSelectHandler, addColorGoalkeepHandler}) => {
    ...
    return (
        <div className={state ?`${styles.modal} ${styles.activeModal}` :styles.modal}>
            <div className={styles.modalContent}>
                <div onClick={closeGoalKModalHandler} className={styles.modalContentIconClose}>
                    <img
                ...
                <div className={styles.modalContentBtn}>
                    <Button clickHandler={addColorGoalkeepHandler}>
                        Done
                    </Button>
                </div>
            </div>
